...
/// Remote data source for FreshRSS.
///
/// FreshRSS is a self-hosted RSS reader that provides a Google Reader API
/// compatible interface. This class wraps [GoogleReaderApi] and handles
/// FreshRSS-specific API differences.
class FreshRssRemoteDataSource {
  final GoogleReaderApi _api;

  /// Creates a new FreshRSS remote data source.
  ///
  /// [serverUrl] is the base URL of the FreshRSS server (e.g., 'https://rss.example.com').
  /// The actual API endpoint will be constructed as `serverUrl/api/greader.php`.
  FreshRssRemoteDataSource({required String serverUrl})
      : _api = GoogleReaderApi(baseUrl: '$serverUrl/api/greader.php');

  /// Authenticates with FreshRSS using username and password.
  ///
