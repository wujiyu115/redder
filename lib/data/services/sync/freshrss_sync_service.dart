import '../../datasources/remote/freshrss_remote_ds.dart';
import '../../datasources/remote/google_reader_api.dart';
import 'sync_models.dart';
import 'sync_service.dart';

/// Sync service implementation for FreshRSS.
///
...
class FreshRssSyncService implements SyncService {
  FreshRssRemoteDataSource? _remoteDataSource;
  SyncCredentials? _credentials;

  @override
  SyncServiceType get serviceType => SyncServiceType.freshRss;

  @override
  String get serviceName => 'FreshRSS';

  @override
  String get serviceIcon => 'freshrss';
  ...
  Future<bool> authenticate(SyncCredentials credentials) async {
    ...
    try {
      _remoteDataSource = FreshRssRemoteDataSource(
  ...
  Future<void> moveFeed(String feedRemoteId, String? folderId) async {
    ...
    // FreshRSS uses tags for folders, so we edit the subscription's tags
  ...
  Future<SyncFolder> createFolder(String name) async {
    ...
    // FreshRSS doesn't have a direct create folder API
